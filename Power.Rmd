...
while(power_SK < 0.8 | power_PP < 0.8 | power_PP < 0.85){
  for(i in 1:nsim){
...
while(power_SK < 0.8 | power_PP < 0.8 | power_PP < 0.8){
  for(i in 1:nsim){
